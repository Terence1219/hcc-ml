...
from utils.utils import weights_init_normal, to_cpu, load_classes
...
if __name__ == "__main__":
    ...
    # Get dataloader
    dataset = ListDataset(
        train_path, multiscale=opt.multiscale_training,
        img_size=opt.img_size, transform=AUGMENTATION_TRANSFORMS)
    ...
    for epoch in range(opt.epochs):
        ...
        if epoch % opt.checkpoint_interval == 0:
            torch.save(
                model.state_dict(), "checkpoints/yolov3_ckpt_%d.pth" % epoch)
